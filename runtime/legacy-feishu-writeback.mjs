...
const LABEL_ALIAS = Object.freeze({
  ...
  '自砌': '款式/自砌', '泡澡桶': '款式/泡澡桶', '加厚': '功能/加厚', '软体': '材质/软体',
  '60cm': '尺寸/60cm', '70cm': '尺寸/70cm', '中古风': '风格/复古', '透明树脂': '材质/树脂',
  '德国汉斯': '品牌/汉斯格雅', '高端': '风格/高级感', '2026': '功能/新款', '新式': '功能/新款',
  '名牌': '需求/品牌榜单', '浪鲸卫浴': '品牌/浪鲸', '九牧卫浴': '品牌/九牧',
  '淋浴': '功能/淋浴组合', '二合一': '功能/淋浴组合', '情趣': '场景/情侣',
  '赛高': '品牌/赛高', '观博': '品牌/观博', '勒示': '品牌/勒示', '杜菲尼': '品牌/杜菲尼',
  'bette': '品牌/Bette', 'roca': '品牌/roca', 'tw': '品牌/tw', 'kohler': '品牌/科勒',
  '官方旗舰店': '需求/官方旗舰店', '弧形': '款式/弧形', '50cm': '尺寸/50cm',
});
