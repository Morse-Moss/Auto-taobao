...
export function applyAdaptiveRun(checkpoint, result) {
  ...
  checkpoint.parts[rangeId(start, end)] = {
    ...
    ...(result.observedProgress ? { observedProgress: structuredClone(result.observedProgress) } : {}),
    ...(result.exportFailure ? { exportFailure: structuredClone(result.exportFailure) } : {}),
    ...
    ...(result.mediaPending ? { mediaPending: [...result.mediaPending] } : {}),
