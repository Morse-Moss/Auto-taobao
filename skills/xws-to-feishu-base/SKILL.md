...
Use `import-competitor-v2.mjs` when the Xiaowangshen export must become a structured competitor-analysis copy. It preserves the 16 source fields, adds the approved calculated/classification fields, and creates exactly these two allowed tables:
